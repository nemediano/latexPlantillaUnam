...
%\algrenewcommand{\algorithmiccomment}[1]{\hskip3em$//$ #1}
%Poniendo los encabezados de los algoritmos en español
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{Notas de estudio de Cálculo} %Titulo de las notas
\fancyhead[C]{José Doroteo Arango Arámbula} % Nombre del autor
...
\usepackage{cancel} %Para negar simbolos de matemáticas

\begin{document}
\maketitle
% El contenido de las notas esta repartido en estos archivos
\tableofcontents
\include{seccion1}
\include{seccion2}
\include{seccion3}
